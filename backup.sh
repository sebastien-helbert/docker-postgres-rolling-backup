...
DAILY_BACKUP_RETENTION_DAYS=${BACKUP_RETENTION_DAILY_BACKUP_RETENTION_DAYS:-7}
 
# How many weeks to keep weekly backups
WEEKLY_BACKUP_RETENTION_DAYS=${BACKUP_RETENTION_WEEKLY_BACKUP_RETENTION_DAYS:-31}

# How many months to keep monthly backups
MONTHLY_BACKUP_RETENTION_DAYS=${BACKUP_RETENTION_MONTHLY_BACKUP_RETENTION_DAYS:-365}
